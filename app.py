...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        header = tk.Label(self.window, text="Student Attendance Registration", width=80, height=2, fg="white", bg="#363e75",
                          font=('times', 18, 'bold', 'underline'))
        header.place(x=0, y=0)
        clientID = tk.Label(self.window, text="Penn State ID", width=10, height=2, fg="white", bg="#363e75", font=('times', 15))
        ...
        empID = tk.Label(self.window, text="PSU Mail", width=10, fg="white", bg="#363e75", height=2, font=('times', 15))
        ...
        lbl3 = tk.Label(self.window, text="Task done : ", width=15, fg="white", bg="#363e75", height=2,
                        font=('times', 15))
